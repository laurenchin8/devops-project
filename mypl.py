...
def run_parse_mode(in_stream):
    ...
    """
    print('ERROR: PARSE mode not supported')
    exit(1)
...
def run_print_mode(in_stream):
    ...
    """
    print('ERROR: PRINT mode not supported')
    exit(1)
...
def run_check_mode(in_stream):
    ...
    """
    print('ERROR: CHECK mode not supported')
    exit(1)
...
def run_ir_mode(in_stream):
    ...
    """
    print('ERROR: IR mode not supported')
    exit(1)
...
def run_normal_mode(in_stream):
    ...
    print('ERROR: NORMAL mode not supported')
    exit(1)
